...
namespace SimpleChat.Migrations
{
    ...
    [Migration("20240711100857_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimpleChat.DbLogic.Chat", b =>
                {
            ...
            modelBuilder.Entity("SimpleChat.DbLogic.Message", b =>
                {
            ...
            modelBuilder.Entity("SimpleChat.DbLogic.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ChatUser", b =>
                {
                    b.HasOne("SimpleChat.DbLogic.Chat", null)
                        .WithMany()
                        .HasForeignKey("ChatsConnectedToChatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SimpleChat.DbLogic.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SimpleChat.DbLogic.Chat", b =>
                {
                    b.HasOne("SimpleChat.DbLogic.User", "HostUser")
            ...
            modelBuilder.Entity("SimpleChat.DbLogic.Message", b =>
                {
                    b.HasOne("SimpleChat.DbLogic.Chat", "Chat")
                        .WithMany("AllMessages")
                        .HasForeignKey("ChatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SimpleChat.DbLogic.User", "User")
